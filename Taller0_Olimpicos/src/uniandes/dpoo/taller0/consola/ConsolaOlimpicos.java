...
public class ConsolaOlimpicos
{
	...
	public void mostrarMenu()
	{
		...
		System.out.println("13. Consultar el atleta que repesenta un pais");
	...
	{
		Pais elPais = null; 
		String atleta = input("Ingrese el nombre del atleta que quiere buscar: ");
		System.out.println("El pais al cual representa el atleta es: ");
		elPais = calculadora.PaisAtleta(atleta);
